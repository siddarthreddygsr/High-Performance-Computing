/*
This is a C program for Conway's "game of life" that takes
input from both command line arguments and a file. The command-line
arguments include the name of an input file or the keyword "random",
the size of the board, and the seed for random-number generation. 
The user also specifies the number of steps and how often to print the results.
If an input file is provided, it should contain the initial board configuration, 
which consists of the size of the board and N*N values, each of which is either 0 or 1.
*/
